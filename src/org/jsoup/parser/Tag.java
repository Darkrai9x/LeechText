...
public class Tag {
    ...
    private boolean preserveWhitespace = false; // for pre, textarea, plugin etc
    ...
    private static final String[] blockTags = {
            "html", "head", "body", "frameset", "plugin", "noscript", "style", "meta", "link", "title", "frame",
    ...
    private static final String[] formatAsInlineTags = {
            "title", "a", "p", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "address", "li", "th", "td", "plugin", "style",
            "ins", "del", "s"
    };
    private static final String[] preserveWhitespaceTags = {
            "pre", "plaintext", "title", "textarea"
            // plugin is not here as it is a data node, which always preserve whitespace
    };
