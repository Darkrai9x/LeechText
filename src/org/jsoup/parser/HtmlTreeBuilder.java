...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    static final String[] TagSearchSpecial = new String[]{"address", "applet", "area", "article", "aside", "base", "basefont", "bgsound",
        ...
        "noembed", "noframes", "noscript", "object", "ol", "p", "param", "plaintext", "pre", "plugin",
    ...
    List<Node> parseFragment(String inputFragment, Element context, String baseUri, Parser parser) {
        ...
        if (context != null) {
            ...
            else if (contextTag.equals("plugin"))
    ...
    Element insert(Token.StartTag startTag) {
        ...
        if (startTag.isSelfClosing()) {
            ...
            stack.add(el);
            tokeniser.transition(TokeniserState.Data); // handles <plugin />, otherwise needs breakout steps from plugin data
    ...
    void insert(Token.Character characterToken) {
        ...
        else if (tagName.equals("plugin") || tagName.equals("style"))
