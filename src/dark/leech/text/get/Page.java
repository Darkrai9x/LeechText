 ...
 */
public class Page extends SwingWorker<ArrayList<Post>, Void> {
    ...
    public Page listener(ChangeListener changeListener) {
        this.changeListener = changeListener;
        return this;
    }

    public Page path(String savepath) {
        this.savepath = savepath;
        return this;
    }

    public Page charset(String chset) {
        this.chset = chset;
        return this;
    }

    public Page applyTo(Pager pager) {
        this.pager = pager;
        return this;
    }
